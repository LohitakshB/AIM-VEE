...
def expand_geom_fid_state_block(
    ...
    # use the passed n_fids, n_states (do NOT overwrite them from EV_block)
...
def prep_data(
    ...
    # 1) per-molecule shuffle & stack (geometry-level)
    ...
    # 2) global shuffle of geometries
    ...
    # 6) Filter VAL/TEST to highest fidelity (TZVP ~ last index)
