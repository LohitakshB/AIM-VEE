"""Train the MFF-MLP (Multi-Fidelity-Fusion MLP) on QeMFi + SchNet features."""
...
def run_mff_mlp(args: argparse.Namespace) -> None:
    ...
    for split_method, train_csv, val_csv, split_output in split_iter:
        ...
        print(f"Using SchNet latent from {latent_name} (dim={latent_dim}).")
